...
"Please go away and stop eating my sheep". Otherwise, return "Oi! Sheep number N!
...
Input
The input will be a single string containing the animals separated by a comma
and a single space ", "
"""
