...
On the final line, you will be given the indices of  send emails separated by comma and space ", ".
Call send() method for the given indices of emails. For each email, call the get_info() method.
